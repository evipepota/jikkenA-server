...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    {
        // let mut tag_csv = CSVReader::from_path("../csv/a.csv")?;
        ...
        for record in geotag_csv.records() {
            ...
            for tag_name in tag_names {
                ...
                entry.push(Geotag {
                    ...
                    lat: record.get(2).unwrap().parse().unwrap(),
                    lon: record.get(3).unwrap().parse().unwrap(),
